...
{
    public partial class MultiDropDownTextBox : DevComponents.DotNetBar.Controls.TextBoxX
    {
        ...
        //    base.InitLayout();
        //}
        public MultiDropDownTextBox(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
        }
        ...
        { 
            ...
            {               
                ...
                _DataGridViewX.Top = this.Parent.Top + this.Top + _DataGridViewX.ColumnHeadersHeight + this.Height ;
                _DataGridViewX.Left = this.Parent.Left + this.Left;
