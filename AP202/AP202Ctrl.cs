...
namespace AP202
{
    class AP202Ctrl
    {
        ...
        public static DataTable LoadAPADjDet(string BrandID, string AdjNbr, string VendID, int Rlsed, DateTime FromDate, DateTime ToDate)
        {
            return ConnectDB.ExecuteReader("AP202_LoadDocs",
                new string[] { "BranchID", "AdjNbr", "VendID", "Rlsed", "FromDate", "ToDate" },
                new Object[] { BrandID, AdjNbr, VendID, Rlsed, FromDate, ToDate });
        }
