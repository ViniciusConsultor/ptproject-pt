...
namespace IN202
{
    public class IN202Ctrl
    {
        ...
        {
            return ConnectDB.ExecuteReader("sp_INDocListGetByPara", new String[] { "ProID", "UserID", "TranType", "FromDate", "ToDate" }, new Object[] { ProID, UserID, TranType, FromDate, ToDate });
        }
        public static DataTable GetINDocDetByDoc(string BranchID, string DocNbr, string Module)
        {
            return ConnectDB.ExecuteReader("sp_INDocDetGetByDoc", new String[] { "BranchID", "DocNbr", "Module" }, new Object[] { BranchID, DocNbr, Module });
        }
